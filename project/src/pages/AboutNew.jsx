...
const AboutNew = () => {
  ...
  return (
    <div className="min-h-screen pt-16 md:pt-20 bg-white">
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-gray-900">
                  ...
                  <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-[#fde047] to-[#85193C] bg-clip-text text-transparent">Festival</span>
                </h1>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="rounded-lg border border-yellow-500 bg-white/80 backdrop-blur-sm shadow-sm hover:border-[#85193C] hover:shadow-xl transition-all duration-300">
                  <div className="p-4 sm:p-6 text-center group">
                    <svg
                      ...
                      className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 mx-auto mb-2 md:mb-4 text-[#FACC15] group-hover:text-[#85193C] transition-colors duration-300"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <h3 className="font-semibold text-lg sm:text-xl mb-1 sm:mb-2 text-[#FACC15] group-hover:text-[#85193C] transition-colors duration-300">
                      5000+
                    </h3>
                ...
                <div className="rounded-2xl border border-[#85193C] bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-md shadow-md hover:shadow-yellow-300/60 hover:shadow-xl hover:border-yellow-400 transition-all duration-300 transform hover:scale-105 group mt-6 sm:mt-8 md:mt-10">
                  <div className="p-4 sm:p-6 md:p-8 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-10 sm:w-10 md:h-14 md:w-14 text-[#85193C] group-hover:text-yellow-500 mx-auto mb-2 md:mb-5 transition-colors duration-300 drop-shadow-md group-hover:drop-shadow-yellow-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 group-hover:text-[#333] transition-colors">
                      Awards Won
                    </p>
                  </div>
                </div>
                ...
                {/* Card 3 */}
                <div className="group rounded-2xl border-2 border-[#85193C] bg-white/80 backdrop-blur-md shadow-md hover:border-yellow-400 hover:ring-yellow-300 transition-all duration-300 transform hover:scale-105">
                  <div className="p-4 sm:p-6 text-center">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 group-hover:text-[#333] transition-colors duration-300">
                      Years Experience
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-yellow-500 bg-white/80 backdrop-blur-sm shadow-sm hover:border-[#85193C] hover:shadow-xl transition-all duration-300">
                  <div className="p-4 sm:p-6 text-center group transition-all duration-300">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-[#FACC15] mx-auto mb-2 md:mb-4 group-hover:text-[#85193C] transition-colors duration-300"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
      ...
      {/* Our Values */}
      <section className="py-12 md:py-20 bg-[#FFF7F9]">
            ...
            {values.map((item, i) => (
              <div key={i} className="bg-white p-6 md:p-8 rounded-2xl shadow-md hover:shadow-xl transform transition-transform hover:-translate-y-2 hover:scale-105 text-center">
                <div className="mb-4 flex justify-center">
                  <div className="bg-[#fce8f0] p-3 md:p-4 rounded-full shadow-inner">
                    {item.icon}
                  </div>
                </div>
