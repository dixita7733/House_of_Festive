...
const Home = () => {
  const features = [
    {
      icon: <Award className="w-6 h-6 lg:w-8 lg:h-8 text-[#85193C]" />,
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl mb-8 text-orange-100 leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              to="/about"
              className="border-2 border-white text-white px-6 lg:px-8 py-3 lg:py-4 rounded-full text-base lg:text-lg font-semibold hover:bg-white hover:text-[#85193C] transition-all duration-300 transform hover:scale-105"
            >
              Our Story
            </Link>
          </div>
      ...
      <section className="py-12 lg:py-16">
        <div className="container mx-auto px-4">
          <div className="responsive-grid -mt-24 lg:-mt-32 relative z-10">
            {stats.map((stat, index) => (
              ...
              >
                <div className="bg-white rounded-2xl p-4 lg:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="text-[#85193C] mb-3 lg:mb-4 flex justify-center">
                    {stat.icon}
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <img
                ...
                className="rounded-2xl shadow-2xl hover:shadow-3xl transition-shadow duration-500 w-full h-64 lg:h-80 object-cover"
              />
            </div>
            <div className="order-1 lg:order-2">
              <h2 className="text-3xl lg:text-4xl font-bold text-[#85193C] mb-6">
                Who We Are
              </h2>
              ...
              <Link
                to="/about"
                className="inline-flex items-center space-x-2 btn-gradient-custom rounded-full"
              >
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-br from-red-50 via-red-50 to-yellow-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#85193C] mb-4">
              Why Choose Us?
            </h2>
          ...
          <div className="responsive-grid">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
              >
                <div className="mb-4 lg:mb-6 group-hover:scale-110 transition-transform duration-300">
                  {feature.icon}
                </div>
                <h3 className="text-lg lg:text-xl font-bold text-gray-800 mb-3 lg:mb-4 group-hover:text-[#85193C] transition-colors">
                  {feature.title}
                </h3>
      ...
      <section className="py-16 lg:py-20">
        <div className="container mx-auto px-4 text-center">
          <div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#85193C] mb-6">
              Ready to Celebrate?
            </h2>
            <p className="responsive-text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Discover our exclusive collection of handcrafted festival
              essentials and make your celebrations unforgettable.
            </p>
            <Link
              to="/products"
              className="inline-flex items-center space-x-2 bg-white text-[#85193C] px-6 lg:px-8 py-3 lg:py-4 rounded-full text-base lg:text-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border-2 border-[#85193C]"
            >
              <span>Shop Now</span>
              <ArrowRight className="w-5 h-5" />
            </Link>
